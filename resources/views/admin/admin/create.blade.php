...
<form action="/admin/admin" method="post" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    <label for="email" class="col-sm-2 control-label">ايميل المستخدم</label>
    <div class="col-sm-10 col-md-5">
    ...
    <div class="col-sm-10 col-md-5">
      <input type="password" class="form-control" value="{{old('password')}}" id="password" ="password" placeholder="ادخل كلمة المرور للمستخدم">
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input {{old('status')?"checked":""}} ="status" type="checkbox"> فعال
        </label>
      </div>
    </div>
  </div>
